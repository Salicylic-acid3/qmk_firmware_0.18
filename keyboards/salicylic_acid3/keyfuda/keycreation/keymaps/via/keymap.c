...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT(
  //,--------------------------------------------|   |-----------------|
        KC_P7,   KC_P8,   KC_P9, KC_PSLS,    KC_Z,     KC_WH_L, KC_WH_R,
  //|--------+--------+--------+--------+--------|   |--------+--------|
        KC_P4,   KC_P5,   KC_P6, KC_PAST, KC_BTN3,     KC_WH_U, KC_WH_D,
  //|--------+--------+--------+--------+--------|   |--------+--------|
        KC_P1,   KC_P2,   KC_P3, KC_PMNS, KC_MUTE,     KC_VOLU, KC_VOLD,
  //|--------+--------+--------+--------+--------|   |--------+--------|
        KC_P0, KC_PDOT, KC_PENT, KC_PPLS,LCTL(KC_S),LCTL(KC_Z),LCTL(KC_Y)
  //|--------------------------------------------|   |-----------------|
  ),
  [1] = LAYOUT(
  //,--------------------------------------------|   |-----------------|
